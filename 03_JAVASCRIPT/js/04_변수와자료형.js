...
function test(){// test 함수 정의
    ...
    console.log("if문 종류 후 num5 :" +num5);
    console.log("if문 종류 후 num6 :" +num6);
...
function typeTest(){
    ...
    //const name2; //상수는 선언과 동시에 초기화기 필수!!
    ...
    typeBox.innerHTML += "<br><br>heigth: " + heigth + "/" + typeof heigth;
    ...
    //함수명만 작성하는 경우 --> 합수에 작성된 코드 자체가 반환
