...
document.getElementById("btn1").addEventListener("click", function(){
    ...
    //자식
    //요소.childNodes: 요서의 자식 노드를 모두 반환(NodeList형태)
    ...
    //#li1의 부모 배경색을 pink로 변경
    li1.parentNode.style.backgroundColor = 'pink'; // 부모요소가 ul이니까 ul 전체가 바뀜
    ...
    console.log(test.childNodes[5].previousSibling); // 인덱스 4번

    //#test의 자식 노드 중 5번째 인덱스의 다음 형제 노드
    console.log(test.childNodes[5].nextSibling);  // 인덱스 6번
...
document.getElementById("btn2").addEventListener("click",function(){
    ...
    //nextElementSiblingL 다음 형제 요소 선택
