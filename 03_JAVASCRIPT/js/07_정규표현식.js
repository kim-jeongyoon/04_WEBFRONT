...
document.getElementById("check2").addEventListener("click",function(){
     ...
     //^(캐럿) : 문자열의 시작을 의미
     const regEx2 = /^group/;
     div1.innerHTML += "/[abcd]/, group100 :"  + regEx2.test("group100")+"<hr>";
     div1.innerHTML += "/[abcd]/, 100group :"  + regEx2.test("100group")+"<hr>";
     ...
     div1.innerHTML += "/team$/, A-team :"  + regEx2.test("A-team")+"<hr>";
     div1.innerHTML += "/team$/, team-A :"  + regEx2.test("team-A")+"<hr>";
